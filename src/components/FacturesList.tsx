          ...
          <div className="space-y-3 md:hidden">
            {filtered.map((inv) => (
              ...
              >
                ...
                <p className="mt-1 text-sm text-slate-500">{formatDate(inv.issueDate)}</p>
              </Link>
            ))}
          </div>
              ...
              <table className="min-w-full text-left text-sm">
                <thead>
                  <tr className="border-b border-slate-100 bg-gradient-to-r from-slate-50 to-brand-light/30 text-xs uppercase tracking-wide text-slate-500">
                    ...
                    <th className="px-5 py-3.5 font-semibold">Lignes</th>
                ...
                <tbody className="divide-y divide-slate-100">
                  {filtered.map((inv) => (
                    ...
                    >
                      ...
                      <td className="px-5 py-4 text-slate-500">{inv.items.length}</td>
